...
const description =
  "Únete a la transformación digital: aumenta tus ventas con tu negocio en internet";
...
export const state = () => ({
  ...
  btn: {
    backToHome:
      'Volver a la <span class="has-text-weight-medium">página de inicio</span>',
  },
  owner: {
    name: ownerName,
    url: url,
    ...
    footer:
      '<span class="has-text-weight-medium">Digitaliza tu</span> <b class="has-text-success">negocio</b>',
